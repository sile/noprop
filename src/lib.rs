...
pub use generator::{
    ...
    sample_f32, sample_f32_in, sample_f64, sample_f64_in, sample_i8, sample_i8_in, sample_i16,
    sample_i16_in, sample_i32, sample_i32_in, sample_i64, sample_i128, sample_isize, sample_ratio,
    sample_string, sample_u8, sample_u8_in, sample_u16, sample_u16_in, sample_u32, sample_u32_in,
    sample_u64, sample_u64_in, sample_u128, sample_usize, sample_usize_in, sample_weighted_index,
