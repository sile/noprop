...
pub use generator::{
    ...
    sample_char, sample_choice, sample_f32, sample_f32_finite, sample_f64, sample_f64_finite,
    sample_i8, sample_i16, sample_i32, sample_i64, sample_i128, sample_isize, sample_ratio,
    sample_u8, sample_u16, sample_u32, sample_u64, sample_u128, sample_usize, sample_usize_in,
